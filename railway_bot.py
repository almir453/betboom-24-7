...
# === Конфигурация ===
API_ID = int(os.getenv("API_ID", "21658972"))
API_HASH = os.getenv("API_HASH", "175d08b358ee5a8c3c7f9555e90c7380")
SESSION_NAME = os.getenv("SESSION_NAME", "my_session")
BOT_TOKEN = os.getenv("BOT_TOKEN", "7996821935:AAG4TMSyo_00gW0tcv5D7Ojosu09edG8Tyk")
CHAT_ID = os.getenv("CHAT_ID", "8370087721")
...
async def init_playwright():
    ...
    logger.info("✅ Страница BetBoom успешно открыта!")
...
async def main():
    try:
        ...
        send_log_to_telegram(f"❌ Ошибка: {e}")
    finally:
